  ...
  return (
    <section className="w-full bg-white px-4 md:px-8 lg:px-16 py-8 md:py-16">
      <div className="max-w-content mx-auto">
        <Reveal variant="scale" className="relative overflow-hidden rounded-xl border border-brand-orange/20 bg-orange-tint/50 px-5 py-6 md:px-10 md:py-10 shadow-sm">
