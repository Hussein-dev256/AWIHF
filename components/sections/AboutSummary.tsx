        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 grid grid-cols-1 sm:grid-cols-2 gap-5 md:gap-6">
            <div className="space-y-5 md:space-y-6">
              <Reveal delayMs={120} className="bg-orange-tint/40 p-5 md:p-6 rounded-2xl border border-brand-orange/10 transition-all duration-300 hover:shadow-md hover:-translate-y-0.5">
              ...
              <Reveal delayMs={220} className="bg-green-tint/40 p-5 md:p-6 rounded-2xl border border-brand-green/10 transition-all duration-300 hover:shadow-md hover:-translate-y-0.5">
            ...
            <Reveal delayMs={180} variant="scale" className="bg-brown-tint/50 p-5 md:p-8 rounded-2xl border border-brand-brown/15 flex flex-col justify-center relative overflow-hidden shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-300 min-h-[190px] md:min-h-[240px]">
              <span className="absolute -right-4 -bottom-6 text-[120px] font-serif text-brand-brown/5 pointer-events-none select-none">&ldquo;</span>
